...
int kwait(int *status)
{
  ...
  { 
    ...
    printf("Didn't find any children. \n");
    // BECAUSE OF LAB 6 WE COMMENTED THIS OUT
    // return 0;
  }
  ...
  while(1)
  {
    ...
    printf("Didn't find dead child proc. Putting P%d to sleep...\n", running->pid);
